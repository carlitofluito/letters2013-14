...
```{r train, fig.cap= "Narcisus drowning in a Belgian. *Leuven (Belgium), 2014-10*", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
...
```{r library, fig.cap= "Before the course started, I went to Leuven to find a place to live during the year. Not only, I found the room, but also a nice bike that still waits for me when I go to Valladolid (Spain). This is the triumphant hunting picture with the prize. *Leuven (Belgium), 2014-07*", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
