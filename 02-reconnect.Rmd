...
```{r tao, fig.cap= "*Leuven (Belgium), March, 2014*: It had happened, and it was going to keep happening.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/2014/tao.jpg")
```
...
```{r study, fig.cap= "*Valladolid (Spain), December, 2013*: I successfully passed the exams thanks to long study sessions in the library like this one.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/2014/study.jpg")
```
...
```{r glove, fig.cap= "*Brussels (Belgium), November, 2013*: Taking out a glove to take a selfie. Very smart behavior in Northen Europe.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/2014/glove.jpg")
```
