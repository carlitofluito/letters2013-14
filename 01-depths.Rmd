...
```{r explorer, fig.cap= "*Leuven (Belgium), September, 2013*: The 24^th^. My 20^th^ birthday. I was exploring the center of the city, enjoying the free beers that one gets only by showing your ID and proving that it is your birthday. Fleeting happiness...", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
