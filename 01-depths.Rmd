...
```{r notas, fig.cap= "*Valladolid (Spain). September, 2013*: The book F. was referring to.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/2013/notas.jpg")
```
...
```{r poemas, fig.cap= "*Valladolid (Spain). September, 2013*: Some poems from the book. Sorry for the lack of translation.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/2013/poemas.jpg")
```
...
```{r sor1, fig.cap= "An original smile.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("docs/images/2013/sor1.jpg")
```
...
```{r sor2, fig.cap= "Degenerated smile.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("docs/images/2013/sor2.jpg")
```
...
```{r sor3, fig.cap= "Beginnings.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("docs/images/2013/sor3.jpg")
```
...
```{r sor4, fig.cap= "Endings.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("docs/images/2013/sor4.jpg")
```
...
```{r room, fig.cap= "*Leuven (Belgium). October, 2013*: This is the very beggining of the story, the room where most of these letters were written. I started there to use a fitness ball as a chair. And that lovely [Pangaea](https://www.kuleuven.be/english/studentservices/pangaea) mug.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/2014/room.jpg")
```


## 2013-11-10. To T. {-#tot20131110}

```{r explorer, fig.cap= "*Leuven (Belgium), September, 2013*: The 24th. My 20th birthday. I was exploring the center of the city, enjoying the free beers that one gets only by showing your ID and proving that it is your birthday. Fleeting happiness...", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/2014/explorer.jpg")
```
...
```{r bike, fig.cap= "*Leuven (Belgium), October, 2013*: I was happy when I settle down. I had my new NorthFace backpack and I was ready to ride around. However, things went differently... ", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/2014/bike.jpg")
```
...
```{r train, fig.cap= "*Somewhere in Belgium. October, 2013*: Narcisus drowning in the train window.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/2014/train.jpg")
```
...
```{r living, fig.cap= "*Valladolid (Spain), January, 2014*: The 6th. [The *Three Magic Kings* night](https://www.donquijote.org/spanish-culture/holidays/the-three-kings/). There were no gifts at my house that night, so I picked up several books around the house and place them on the living room.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/2014/living.jpg")
```
...
```{r smartphone, fig.cap= "*Brugges (Belgium), December, 2013*: Black Mirror's victim was about getting liberated.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/2014/smartphone.jpg")
```